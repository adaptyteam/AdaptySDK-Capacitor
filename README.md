...
```typescript
activate(options: { apiKey: string; configuration: AdaptyConfiguration; }) => Promise<void>
```
...
| Param         | Type                                                                                                    |
| ------------- | ------------------------------------------------------------------------------------------------------- |
| **`options`** | <code>{ apiKey: string; configuration: <a href="#adaptyconfiguration">AdaptyConfiguration</a>; }</code> |
...
| **`cross_platform_sdk_name`**         | <code>string</code>  |
| **`cross_platform_sdk_version`**      | <code>string</code>  |
| **`customer_user_id`**                | <code>string</code>  |
| **`observer_mode`**                   | <code>boolean</code> |
| **`ip_address_collection_disabled`**  | <code>boolean</code> |
| **`log_level`**                       | <code>string</code>  |
| **`server_cluster`**                  | <code>string</code>  |
| **`backend_base_url`**                | <code>string</code>  |
| **`backend_fallback_base_url`**       | <code>string</code>  |
| **`backend_configs_base_url`**        | <code>string</code>  |
| **`backend_proxy_host`**              | <code>string</code>  |
| **`backend_proxy_port`**              | <code>number</code>  |
| **`activate_ui`**                     | <code>boolean</code> |
| **`media_cache`**                     | <code>any</code>     |
| **`apple_idfa_collection_disabled`**  | <code>boolean</code> |
| **`google_adid_collection_disabled`** | <code>boolean</code> |
