...
Follow our [quickstart guide](https://adapty.io/docs/kmp-sdk-overview#get-started?utm_source=github&utm_medium=referral&utm_campaign=AdaptySDK-Capacitor) to install and configure Adapty SDK. Set up purchases in hours instead of weeks 🚀
...
Adapty is available under the MIT license. [Click here](https://github.com/adaptyteam/AdaptySDK-Capacitor/blob/master/LICENSE) for details.
