...
/**
 * Integration tests for PaywallViewController methods
 *
 ...
 */
describe('PaywallViewController Methods (Bridge Integration)', () => {
  let adapty: Adapty;
  ...
  describe('createPaywallView', () => {
    it('should send AdaptyUICreatePaywallView.Request with default parameters', async () => {
      ...
      const request = extractNativeRequest<components['requests']['AdaptyUICreatePaywallView.Request']>({
      ...
      expect(request.preload_products).toBe(true);
  ...
  describe('present', () => {
    it('should send request with default full_screen presentation style', async () => {
      ...
      const request = extractNativeRequest<components['requests']['AdaptyUIPresentPaywallView.Request']>({
        nativeModule: nativeMock,
      });
  ...
  describe('dismiss', () => {
    it('should send AdaptyUIDismissPaywallView.Request', async () => {
      ...
      const request = extractNativeRequest<components['requests']['AdaptyUIDismissPaywallView.Request']>({
        nativeModule: nativeMock,
      });
