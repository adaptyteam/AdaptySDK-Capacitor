...
describe('Adapty - Installation Status (Bridge Integration)', () => {
  ...
  beforeEach(async () => {
    ...
    nativeMock = createNativeModuleMock({
      ...
      get_current_installation_status: GET_CURRENT_INSTALLATION_STATUS_RESPONSE_DETERMINED,
    });
  ...
  describe('getCurrentInstallationStatus', () => {
    ...
    it('should return status "not_determined" without details', async () => {
      nativeMock = createNativeModuleMock({
        activate: ACTIVATE_RESPONSE_SUCCESS,
        get_current_installation_status: GET_CURRENT_INSTALLATION_STATUS_RESPONSE_NOT_DETERMINED,
      });
    ...
    it('should return status "not_available" without details', async () => {
      nativeMock = createNativeModuleMock({
        activate: ACTIVATE_RESPONSE_SUCCESS,
        get_current_installation_status: GET_CURRENT_INSTALLATION_STATUS_RESPONSE_NOT_AVAILABLE,
      });
